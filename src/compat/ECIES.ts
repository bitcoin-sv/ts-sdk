...
// export class Ecies {
//     public static ivkEkM(privKey: PrivKey, pubKey: PubKey): { iv: Buffer; kE: Buffer; kM: Buffer } {
//         const r = privKey.bn
...
//     public static electrumEncrypt(messageBuf: Buffer, toPubKey: PubKey, fromKeyPair: KeyPair, noKey = false): Buffer {
...
//     public static electrumDecrypt(encBuf: Buffer, toPrivKey: PrivKey, fromPubKey: PubKey = null): Buffer {
...
//     public static bitcoreDecrypt(encBuf: Buffer, toPrivKey: PrivKey): Buffer {
...
//     public static async asyncBitcoreDecrypt(encBuf: Buffer, toPrivKey: PrivKey): Promise<Buffer> {
