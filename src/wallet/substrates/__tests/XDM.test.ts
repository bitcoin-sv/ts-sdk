...
describe('XDMSubstrate', () => {
  let xdmSubstrate
  let originalWindow
  let eventHandlers: { message: (event: MessageEvent) => void } = {
  ...
  describe('constructor', () => {
    it('should throw if window is not an object', () => {
      ...
      expect(() => new XDMSubstrate()).toThrow(
    ...
    it('should throw if window.postMessage is not an object', () => {
      if (typeof global.window !== 'undefined') {
        delete (global.window as { postMessage?: typeof window.postMessage }).postMessage
      }
      expect(() => new XDMSubstrate()).toThrow(
  ...
  describe('invoke', () => {
    ...
    it('should resolve when receiving a valid message', async () => {
      ...
      eventHandlers.message(event as MessageEvent)
