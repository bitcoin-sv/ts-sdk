...
describe('Transaction Verification Benchmark', () => {
  ...
  it('verifies a transaction with a deep input chain', async () => {
    ...
    console.log(
      `Verification time for deep chain of depth ${depth}: ${timeTaken.toFixed(2)} ms`
    )
  })
  ...
  it('verifies a transaction with a wide input set', async () => {
    ...
    console.log(
      `Verification time for wide transaction with ${inputCount} inputs: ${timeTaken.toFixed(2)} ms`
    )
  })
  ...
  it('verifies a large transaction with many inputs and outputs', async () => {
    ...
    console.log(
      `Verification time for large transaction with ${inputCount} inputs and ${outputCount} outputs: ${timeTaken.toFixed(2)} ms`
    )
  })
  ...
  it('verifies a transaction with nested inputs (complex graph)', async () => {
    ...
    console.log(
      `Verification time for nested inputs with depth ${depth} and fan-out ${fanOut}: ${timeTaken.toFixed(2)} ms`
    )
  })
})
